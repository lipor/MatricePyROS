...
class MissionCancelRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionCancelRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionCancelRequest(null);
    return resolved;
    }
};
...
class MissionCancelResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionCancelResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionCancelResponse(null);
...
module.exports = {
  ...
  datatype() { return 'dji_sdk/MissionCancel'; }
};

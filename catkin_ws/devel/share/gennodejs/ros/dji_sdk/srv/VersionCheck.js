...
class VersionCheckRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VersionCheckRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new VersionCheckRequest(null);
    return resolved;
    }
};
...
class VersionCheckResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new VersionCheckResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new VersionCheckResponse(null);
...
module.exports = {
  ...
  datatype() { return 'dji_sdk/VersionCheck'; }
};

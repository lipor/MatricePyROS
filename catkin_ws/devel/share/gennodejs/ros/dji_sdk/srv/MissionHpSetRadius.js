...
class MissionHpSetRadiusRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionHpSetRadiusRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionHpSetRadiusRequest(null);
...
class MissionHpSetRadiusResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionHpSetRadiusResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionHpSetRadiusResponse(null);
...
module.exports = {
  ...
  md5sum() { return '44e997bb8d1a50ef179a59895af1c426'; },
  datatype() { return 'dji_sdk/MissionHpSetRadius'; }
};

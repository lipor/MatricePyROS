...
class AttitudeControlRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AttitudeControlRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AttitudeControlRequest(null);
...
class AttitudeControlResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AttitudeControlResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AttitudeControlResponse(null);
...
module.exports = {
  ...
  md5sum() { return '29c0571c7f764a69752f1f1d3dac2ca2'; },
  datatype() { return 'dji_sdk/AttitudeControl'; }
};

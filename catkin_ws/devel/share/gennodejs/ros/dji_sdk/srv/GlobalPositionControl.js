...
class GlobalPositionControlRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GlobalPositionControlRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalPositionControlRequest(null);
...
class GlobalPositionControlResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GlobalPositionControlResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalPositionControlResponse(null);
...
module.exports = {
  ...
  md5sum() { return '760463c3d8356eaf13428439b7b2ac10'; },
  datatype() { return 'dji_sdk/GlobalPositionControl'; }
};

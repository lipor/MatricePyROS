...
class SendDataToRemoteDeviceRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SendDataToRemoteDeviceRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendDataToRemoteDeviceRequest(null);
...
class SendDataToRemoteDeviceResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new SendDataToRemoteDeviceResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SendDataToRemoteDeviceResponse(null);
...
module.exports = {
  ...
  datatype() { return 'dji_sdk/SendDataToRemoteDevice'; }
};

...
class MissionStartRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionStartRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionStartRequest(null);
    return resolved;
    }
};
...
class MissionStartResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionStartResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionStartResponse(null);
...
module.exports = {
  ...
  datatype() { return 'dji_sdk/MissionStart'; }
};

...
class DroneTaskActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DroneTaskGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DroneTaskActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = DroneTaskGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new DroneTaskGoal()
    }

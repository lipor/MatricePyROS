...
class GlobalPositionNavigationActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GlobalPositionNavigationGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GlobalPositionNavigationActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = GlobalPositionNavigationGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GlobalPositionNavigationActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = GlobalPositionNavigationGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new GlobalPositionNavigationGoal()
    }

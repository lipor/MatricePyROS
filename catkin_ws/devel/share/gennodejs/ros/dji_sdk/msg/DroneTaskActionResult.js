...
class DroneTaskActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = DroneTaskResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DroneTaskActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = DroneTaskResult.Resolve(msg.result)
    }
    else {
      resolved.result = new DroneTaskResult()
    }

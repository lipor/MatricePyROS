...
class LocalPositionNavigationActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = LocalPositionNavigationGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new LocalPositionNavigationActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = LocalPositionNavigationGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LocalPositionNavigationActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = LocalPositionNavigationGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new LocalPositionNavigationGoal()
    }

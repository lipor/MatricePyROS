...
class MissionWaypointAction {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.command_list.length !== 15) {
      throw new Error('Unable to serialize array field command_list - length must be 15')
    }
    // Serialize message field [command_list]
    bufferOffset = _arraySerializer.uint8(obj.command_list, buffer, bufferOffset, 15);
    // Check that the constant length array field [command_parameter] has the right length
    if (obj.command_parameter.length !== 15) {
      throw new Error('Unable to serialize array field command_parameter - length must be 15')
    }
    // Serialize message field [command_parameter]
    bufferOffset = _arraySerializer.int16(obj.command_parameter, buffer, bufferOffset, 15);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.command_list = _arrayDeserializer.uint8(buffer, bufferOffset, 15)
    // Deserialize message field [command_parameter]
    data.command_parameter = _arrayDeserializer.int16(buffer, bufferOffset, 15)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.command_list !== undefined) {
      ...
      resolved.command_list = new Array(15).fill(0)
    }
    ...
    if (msg.command_parameter !== undefined) {
      ...
      resolved.command_parameter = new Array(15).fill(0)
    }

...
class WebWaypointReceiveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new WebWaypointReceiveFeedback();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type WebWaypointReceiveActionFeedback
    ...
    bufferOffset = WebWaypointReceiveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type WebWaypointReceiveActionFeedback
    let len;
    let data = new WebWaypointReceiveActionFeedback(null);
    ...
    data.feedback = WebWaypointReceiveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WebWaypointReceiveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = WebWaypointReceiveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new WebWaypointReceiveFeedback()
    }
...
module.exports = WebWaypointReceiveActionFeedback;

...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_i7f().pack(_x.ts, _x.q0, _x.q1, _x.q2, _x.q3, _x.wx, _x.wy, _x.wz))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ts, _x.q0, _x.q1, _x.q2, _x.q3, _x.wx, _x.wy, _x.wz,) = _get_struct_i7f().unpack(str[start:end])
      return self

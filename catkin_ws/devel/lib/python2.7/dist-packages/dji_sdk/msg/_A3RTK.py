...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I2d4fh2B().pack(_x.date, _x.time, _x.longitude_RTK, _x.latitude_RTK, _x.height_above_sea_RTK, _x.velocity_north, _x.velocity_east, _x.velocity_ground, _x.yaw, _x.position_flag, _x.yaw_flag))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.date, _x.time, _x.longitude_RTK, _x.latitude_RTK, _x.height_above_sea_RTK, _x.velocity_north, _x.velocity_east, _x.velocity_ground, _x.yaw, _x.position_flag, _x.yaw_flag,) = _get_struct_2I2d4fh2B().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_2I2d4fh2B = None
def _get_struct_2I2d4fh2B():
    global _struct_2I2d4fh2B
    if _struct_2I2d4fh2B is None:
        _struct_2I2d4fh2B = struct.Struct("<2I2d4fh2B")
    return _struct_2I2d4fh2B

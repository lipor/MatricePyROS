...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4B().pack(_x.mission_type, _x.target_waypoint, _x.current_status, _x.error_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.mission_type, _x.target_waypoint, _x.current_status, _x.error_code,) = _get_struct_4B().unpack(str[start:end])
      return self

...
"""autogenerated by genpy from dji_sdk/DroneTaskActionFeedback.msg. Do not edit."""
import sys
...
class DroneTaskActionFeedback(genpy.Message):
  _md5sum = "7621a2e43f928a58531cbe04256ab948"
  _type = "dji_sdk/DroneTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dji_sdk/DroneTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DroneTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dji_sdk.msg.DroneTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dji_sdk.msg.DroneTaskFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.progress,) = _get_struct_B().unpack(str[start:end])
      return self

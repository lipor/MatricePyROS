...
"""autogenerated by genpy from dji_sdk/WaypointNavigationActionGoal.msg. Do not edit."""
import sys
...
class WaypointNavigationActionGoal(genpy.Message):
  _md5sum = "49f49517b930bbcd0bbed351eb82f94f"
  _type = "dji_sdk/WaypointNavigationActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','dji_sdk/WaypointNavigationGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(WaypointNavigationActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = dji_sdk.msg.WaypointNavigationGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = dji_sdk.msg.WaypointNavigationGoal()

...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.command_list is None:
        self.command_list = b'\0'*15
      if self.command_parameter is None:
        self.command_parameter = [0] * 15
    else:
      self.action_repeat = 0
      self.command_list = b'\0'*15
      self.command_parameter = [0] * 15
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        buff.write(_get_struct_15B().pack(*_x))
      else:
        buff.write(_get_struct_15s().pack(_x))
      buff.write(_get_struct_15h().pack(*self.command_parameter))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.command_parameter = _get_struct_15h().unpack(str[start:end])
      return self

...
"""autogenerated by genpy from dji_sdk/DroneTaskActionResult.msg. Do not edit."""
import sys
...
class DroneTaskActionResult(genpy.Message):
  _md5sum = "e5f62eb2cecdccdb33834c1bf0d40a1c"
  _type = "dji_sdk/DroneTaskActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dji_sdk/DroneTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DroneTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dji_sdk.msg.DroneTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dji_sdk.msg.DroneTaskResult()

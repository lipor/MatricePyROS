...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2I3i3f().pack(_x.date, _x.time, _x.longitude, _x.latitude, _x.height_above_sea, _x.velocity_north, _x.velocity_east, _x.velocity_ground))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.date, _x.time, _x.longitude, _x.latitude, _x.height_above_sea, _x.velocity_north, _x.velocity_east, _x.velocity_ground,) = _get_struct_2I3i3f().unpack(str[start:end])
      return self
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2I3i3f = None
def _get_struct_2I3i3f():
    global _struct_2I3i3f
    if _struct_2I3i3f is None:
        _struct_2I3i3f = struct.Struct("<2I3i3f")
    return _struct_2I3i3f

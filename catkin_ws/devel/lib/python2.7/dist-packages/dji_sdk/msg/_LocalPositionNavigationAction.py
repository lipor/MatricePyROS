...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3f3I().pack(_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_3B().pack(_x.action_feedback.feedback.x_progress, _x.action_feedback.feedback.y_progress, _x.action_feedback.feedback.z_progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.x, _x.action_goal.goal.y, _x.action_goal.goal.z, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_3f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.x_progress, _x.action_feedback.feedback.y_progress, _x.action_feedback.feedback.z_progress,) = _get_struct_3B().unpack(str[start:end])
      return self

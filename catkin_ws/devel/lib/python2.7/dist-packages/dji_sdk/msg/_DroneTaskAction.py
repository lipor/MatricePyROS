...
"""autogenerated by genpy from dji_sdk/DroneTaskAction.msg. Do not edit."""
import sys
...
class DroneTaskAction(genpy.Message):
  _md5sum = "c55c42528bd771a3225dc80f47f60328"
  _type = "dji_sdk/DroneTaskAction"
...
"""
  ...
  _slot_types = ['dji_sdk/DroneTaskActionGoal','dji_sdk/DroneTaskActionResult','dji_sdk/DroneTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(DroneTaskAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = dji_sdk.msg.DroneTaskActionGoal()
      if self.action_result is None:
        self.action_result = dji_sdk.msg.DroneTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = dji_sdk.msg.DroneTaskActionFeedback()
    else:
      self.action_goal = dji_sdk.msg.DroneTaskActionGoal()
      self.action_result = dji_sdk.msg.DroneTaskActionResult()
      self.action_feedback = dji_sdk.msg.DroneTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B3I().pack(_x.action_goal.goal.task, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_feedback.feedback.progress))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.task, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_B3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.progress,) = _get_struct_B().unpack(str[start:end])
      return self

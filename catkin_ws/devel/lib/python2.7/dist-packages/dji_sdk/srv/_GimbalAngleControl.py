...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_4h4B().pack(_x.yaw, _x.roll, _x.pitch, _x.duration, _x.absolute_or_incremental, _x.yaw_cmd_ignore, _x.roll_cmd_ignore, _x.pitch_cmd_ignore))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.yaw, _x.roll, _x.pitch, _x.duration, _x.absolute_or_incremental, _x.yaw_cmd_ignore, _x.roll_cmd_ignore, _x.pitch_cmd_ignore,) = _get_struct_4h4B().unpack(str[start:end])
...
def _get_struct_I():
    ...
    return _struct_I
_struct_4h4B = None
def _get_struct_4h4B():
    global _struct_4h4B
    if _struct_4h4B is None:

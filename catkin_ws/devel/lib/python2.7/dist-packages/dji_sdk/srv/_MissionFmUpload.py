...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2B2dHB().pack(_x.followme_task.mode, _x.followme_task.yaw_mode, _x.followme_task.initial_latitude, _x.followme_task.initial_longitude, _x.followme_task.initial_altitude, _x.followme_task.sensitivity))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.followme_task.mode, _x.followme_task.yaw_mode, _x.followme_task.initial_latitude, _x.followme_task.initial_longitude, _x.followme_task.initial_altitude, _x.followme_task.sensitivity,) = _get_struct_2B2dHB().unpack(str[start:end])
      return self
...
def _get_struct_I():
    ...
    return _struct_I
_struct_2B2dHB = None
def _get_struct_2B2dHB():
    global _struct_2B2dHB
    if _struct_2B2dHB is None:
        _struct_2B2dHB = struct.Struct("<2B2dHB")
    return _struct_2B2dHB
# This Python file uses the following encoding: utf-8
